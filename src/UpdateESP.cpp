...
UpdateESP::UpdateESP(void)
        : _httpClientTimeout(8000), _ledPin(-1)
{
}

UpdateESP::UpdateESP(int httpClientTimeout)
...
UpdateESPResult UpdateESP::update(WiFiClient& client, const String& url, const String& currentVersion)
{
    HTTPClient http;
...
UpdateESPResult UpdateESP::updateSpiffs(WiFiClient& client, const String& url, const String& currentVersion)
{
    HTTPClient http;
    if(!http.begin(client, url))
    {
...
UpdateESPResult UpdateESP::update(WiFiClient& client, const String& host, uint16_t port, const String& uri,
 ...
 */
int UpdateESP::getLastError(void)
{
    return _lastError;
}
 ...
 * @return String error
 */
String UpdateESP::getLastErrorString(void)
{
 ...
 * @return UpdateESPResult
 */
UpdateESPResult UpdateESP::handleUpdate(HTTPClient& http, const String& currentVersion, bool spiffs)
{

    UpdateESPResult ret = HTTP_UPDATE_FAILED;
 ...
 */
bool UpdateESP::runUpdate(Stream& in, uint32_t size, String md5, int command)
{
